...
class ApplicationViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(method='get', auto_schema=None, operation_description="GET /api/dispatcher/applications/{id}/approve/")
    ...
    @swagger_auto_schema(method='get', auto_schema=None, operation_description="GET /api/dispatcher/applications/{id}/refuse/")
    @action(methods=["GET"], detail=True)
    def refuse(self):
        application = self.get_object()
